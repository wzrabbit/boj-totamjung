import{j as n}from"./jsx-runtime-SwSI87LU.js";import{y as t}from"./styled-components.browser.esm-DmPUYCQi.js";import{a as d}from"./index-CElCL35T.js";import{u}from"./useTranslation-CHmiwnmk.js";const a=(e,r)=>r==="bronze"?e.solvedAcTiers.BRONZE:r==="silver"?e.solvedAcTiers.SILVER:r==="gold"?e.solvedAcTiers.GOLD:r==="platinum"?e.solvedAcTiers.PLATINUM:r==="diamond"?e.solvedAcTiers.DIAMOND:r==="ruby"?e.solvedAcTiers.RUBY:e.colors.GRAY_500,c=t.li`
  width: 32px;
  height: 32px;
`,p=t.button`
  display: flex;
