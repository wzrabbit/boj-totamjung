...
}`,...(h=(u=e.parameters)==null?void 0:u.docs)==null?void 0:h.source},description:{story:"오류 메시지가 굉장히 긴 경우에는 여러 줄에 걸쳐서 표시되며, 이 경우 오류 메시지가 등장했다가 숨겨졌을 때 레이아웃의 높이가 의도치 않게 변환될 수 있으므로, `height` prop을 사용한 고정된 높이 사용을 추천드립니다.\n\n본 예시에서는 `height: 200px` 로 설정하였으며, 더 긴 오류 메시지도 수용할 수 있도록 높이가 늘어났음을 확인할 수 있습니다.\n\n`height` prop은 필수값이 아니며, 명시하지 않을 경우 `height`는 `auto`가 됩니다. 한 줄짜리 에러 메시지를 표시해야 할 때 적합합니다.",...(S=(f=e.parameters)==null?void 0:f.docs)==null?void 0:S.description}}};const T=["Default16px","Default14px","Default13px","LongMessage16px"];export{o as Default13px,s as Default14px,r as Default16px,e as LongMessage16px,T as __namedExportsOrder,L as default};
