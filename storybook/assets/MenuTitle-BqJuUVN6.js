import{j as t}from"./jsx-runtime-SwSI87LU.js";import{y as i}from"./styled-components.browser.esm-DmPUYCQi.js";import{g as l}from"./getTransparentHexColor-DN69VCBw.js";const s=i.div`
  display: inline-flex;
...
`,a=i.img`
  ...
  filter: ${({theme:e})=>e.filters.ORANGE};
  object-fit: contain;
`,d=i.div`
  flex-shrink: 0;
...
`,x=i.div`
  ...
  height: 10px;
  border-radius: 5px;
  background-color: ${({theme:e})=>l(e.colors.ORANGE,.25)};
