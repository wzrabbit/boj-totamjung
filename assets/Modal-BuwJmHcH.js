...
`,y=t.div`
  ...
  background-color: ${({theme:o})=>o.color.DARK_BROWN};
`,D=o=>{const{onEscKeyPress:n}=o,u=r=>{r.key==="Escape"&&n()};l.useEffect(()=>(window.addEventListener("keydown",u),()=>{window.removeEventListener("keydown",u)}),[n])},i=o=>{const{title:n,open:u,onClose:r,children:s}=o;return D({onEscKeyPress:r}),u&&c.createPortal(e.jsxs(C,{children:[e.jsx(p,{onClick:r}),e.jsxs(B,{role:"dialog",children:[e.jsxs(x,{children:[e.jsx(f,{children:n}),e.jsx(m,{onClick:r,"aria-label":"모달 닫기",children:e.jsx(d,{})})]}),e.jsx(h,{children:s})]})]}),document.body)},a=o=>{const{children:n}=o;return e.jsx(y,{children:n})};try{a.displayName="ModalActionButtonsContainer",a.__docgenInfo={description:"`<Modal>` 컴포넌트의 하단 버튼 메뉴들을 만들 때 사용될 보조 컴포넌트입니다.\n이 컴포넌트는 `<Modal>` 컴포넌트의 단순 부속품을 넘어 사용자가 사용할 때 보조적으로 사용하므로\n본 컴포넌트 파일에 같이 정의합니다.",displayName:"ModalActionButtonsContainer",props:{}}}catch{}try{i.displayName="Modal",i.__docgenInfo={description:"",displayName:"Modal",props:{title:{defaultValue:null,description:"",name:"title",required:!0,type:{name:"string"}},open:{defaultValue:null,description:"",name:"open",required:!0,type:{name:"boolean"}},onClose:{defaultValue:null,description:"",name:"onClose",required:!0,type:{name:"() => void"}}}}}catch{}export{i as M,a};
