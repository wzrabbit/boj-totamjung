import{j as t}from"./jsx-runtime-DEdD30eg.js";import{R as D}from"./RandomDefenseHistoryList-BmEo4GUj.js";import{r as m}from"./index-RYns6xqu.js";import{S as l}from"./commands-BRsa08kP.js";import{c as y,d as R,e as _,f as S,g as T,h as N}from"./randomDefense-CSn7TOcu.js";import{i as g}from"./randomDefenseHistoryValidator-HqCX0m6_.js";import{c as b}from"./typeGuards-BB3TV_oj.js";import{b as M,c as A}from"./defaultValues-B69Rceu1.js";import{d as i}from"./styled-components.browser.esm-CkAH7aAm.js";import{S as j}from"./Switch-HPixtSTV.js";import{N as w}from"./NamedFrame-D-XXrU6-.js";import{S as L}from"./trash-CO6QCs-j.js";import{S as O}from"./package-F1HZRHho.js";import{S as v}from"./SimpleModal-k5RQWRZ5.js";import{u as $}from"./useModal-CV8qRtLl.js";const k=e=>{if(!b(e))return!1;const[s,o,r,n,a,d,p]=e.split(/[-:.TZ]/).map(Number);return s>=1&&s<=9999&&o>=1&&o<=12&&r>=1&&r<=31&&n>=0&&n<=23&&a>=0&&a<=59&&d>=0&&d<=59&&p>=0&&p<=999},z=e=>g(e)&&e.problemId%1===0&&e.problemId>=R&&e.problemId<=_&&e.title.length<=S&&k(e.createdAt)&&e.tier%1===0&&e.tier>=T&&e.tier<=N,H=e=>{if(!Array.isArray(e))return M;const s=[];return e.forEach(o=>{g(o)&&z(o)&&s.push(o)}),s.slice(0,y)},B=e=>typeof e=="boolean"?e:A,u=e=>[...e].sort((s,o)=>s.createdAt>o.createdAt?-1:1),C=async()=>{const e=await browser.storage.local.get([l.RANDOM_DEFENSE_HISTORY,l.IS_TIER_HIDDEN]),s=e[l.RANDOM_DEFENSE_HISTORY],o=e[l.IS_TIER_HIDDEN],r=H(s),n=u(r),a=B(o);return{randomDefenseHistory:n,isHidden:a}},F=(e,s)=>{if(!Array.isArray(e)||typeof s!="boolean")return;const o=H(e),r=u(o);browser.storage.local.set({[l.RANDOM_DEFENSE_HISTORY]:r,[l.IS_TIER_HIDDEN]:s})},P=()=>{const[e,s]=m.useState([]),[o,r]=m.useState(!0),[n,a]=m.useState(!1),d=e.length===0;return m.useEffect(()=>{(async()=>{const c=await C();r(c.isHidden),s(c.randomDefenseHistory),a(!0)})()},[]),m.useEffect(()=>{n&&F(e,o)},[e,o]),{items:e,isHidden:o,isLoaded:n,isEmpty:d,deleteHistoryById:c=>{const E=e.filter(f=>`${f.problemId}-${f.createdAt}`!==c);s(E)},clearHistory:()=>{s([])},updateIsHidden:c=>{r(c.target.checked)}}},Y=i.div`
  display: flex;
