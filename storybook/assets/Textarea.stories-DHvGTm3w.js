import{j as x}from"./jsx-runtime-SwSI87LU.js";import{r as E}from"./index-C5e9SFkp.js";import{y as b}from"./styled-components.browser.esm-DmPUYCQi.js";import{g as y}from"./getTransparentHexColor-DN69VCBw.js";import{f as u}from"./index-BnbMJD-K.js";const L=b.textarea`
  width: ${({$width:e})=>e};
  height: ${({$height:e})=>e};
  padding: 6px;
  ...
  &:active {
    ...
    outline: 3px solid
      ${({theme:e,$hasError:r})=>y(r?e.colors.RED:e.colors.LEMON,.44)};
  }
...
}`,...(p=(d=n.parameters)==null?void 0:d.docs)==null?void 0:p.source}}};const C=["Default","Error"];export{a as Default,n as Error,C as __namedExportsOrder,q as default};
