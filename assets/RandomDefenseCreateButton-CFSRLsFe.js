...
`,r=e=>{const{selectedSlotNo:a,isLoaded:n,onClick:c}=e;return t.jsxs(i,{type:"button","aria-label":`${a}번 슬롯에 추첨 생성하기`,onClick:c,disabled:!n,children:[t.jsxs(u,{children:[t.jsx(m,{children:t.jsx(p,{})}),t.jsxs(v,{children:[t.jsx(h,{children:"추첨 생성"}),t.jsx(f,{children:n?`슬롯 번호 − ${a}`:"로딩 중..."})]})]}),t.jsx(x,{})]})};try{r.displayName="RandomDefenseCreateButton",r.__docgenInfo={description:"",displayName:"RandomDefenseCreateButton",props:{selectedSlotNo:{defaultValue:null,description:"",name:"selectedSlotNo",required:!0,type:{name:"enum",value:[{value:"0"},{value:"1"},{value:"2"},{value:"3"},{value:"4"},{value:"5"},{value:"6"},{value:"7"},{value:"8"},{value:"9"}]}},isLoaded:{defaultValue:null,description:"",name:"isLoaded",required:!0,type:{name:"boolean"}},onClick:{defaultValue:null,description:"",name:"onClick",required:!0,type:{name:"(event: MouseEvent<HTMLButtonElement, MouseEvent>) => void"}}}}}catch{}export{r as R};
