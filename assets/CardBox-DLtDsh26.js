...
`,_=n.img`
  ...
  ${({$isCardBoxOpening:a})=>a&&s`
    ...
    `}
`,x=a=>{const{color:r,isTierHidden:l,cardRanks:c,onFirstClick:h,onOpenAnimationEnd:$}=a,[e,b]=y.useState(!1),p=c[0],m=c[1],u=c[2];return t.jsx(R,{children:t.jsxs(C,{onClick:()=>{b(i=>(i||h(),!0))},$isCardBoxOpening:e,onAnimationEnd:i=>{e&&i.target===i.currentTarget&&$()},"aria-label":"카드 상자를 열어 추첨 진행하기",children:[t.jsx(v,{$isCardBoxOpening:e}),t.jsx(Y,{src:f.inside[r],draggable:!1}),t.jsxs(j,{$isCardBoxOpening:e,children:[p&&t.jsx(g,{src:p!=="unrated"&&l?o.hidden:o[p],draggable:!1,alt:"",$isCardBoxOpening:e,$top:"0",$delay:1.5}),m&&t.jsx(g,{src:m!=="unrated"&&l?o.hidden:o[m],draggable:!1,alt:"",$isCardBoxOpening:e,$top:"4%",$delay:1.65}),u&&t.jsx(g,{src:u!=="unrated"&&l?o.hidden:o[u],draggable:!1,alt:"",$isCardBoxOpening:e,$top:"8%",$delay:1.8})]}),t.jsx(A,{src:f.front[r],draggable:!1,alt:""}),t.jsx(_,{src:f.top[r],draggable:!1,alt:"",$isCardBoxOpening:e})]})})};try{x.displayName="CardBox",x.__docgenInfo={description:"",displayName:"CardBox",props:{color:{defaultValue:null,description:"",name:"color",required:!0,type:{name:"enum",value:[{value:'"gold"'},{value:'"black"'},{value:'"red"'},{value:'"green"'},{value:'"blue"'}]}},isTierHidden:{defaultValue:null,description:"",name:"isTierHidden",required:!0,type:{name:"boolean"}},cardRanks:{defaultValue:null,description:"",name:"cardRanks",required:!0,type:{name:"[Rank] | [Rank, Rank] | [Rank, Rank, Rank]"}},onFirstClick:{defaultValue:null,description:"",name:"onFirstClick",required:!0,type:{name:"() => void"}},onOpenAnimationEnd:{defaultValue:null,description:"",name:"onOpenAnimationEnd",required:!0,type:{name:"() => void"}}}}}catch{}export{x as C};
