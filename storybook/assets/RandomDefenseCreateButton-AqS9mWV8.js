import{j as t}from"./jsx-runtime-Cf8x2fCZ.js";import{d as o,l as d}from"./styled-components.browser.esm-CIS6JKSM.js";const r=o.button`
  position: relative;
...
`,i=e=>{const{selectedSlotNo:n,isLoaded:l,onClick:a}=e;return t.jsxs(r,{type:"button","aria-label":`${n}번 슬롯에 추첨 생성하기`,onClick:a,disabled:!l,children:[t.jsxs(c,{children:[t.jsx(p,{src:browser.runtime.getURL("/dice.png"),alt:""}),t.jsxs(x,{children:[t.jsx(m,{children:"추첨 생성"}),t.jsx(f,{children:l?`슬롯 번호 − ${n}`:"로딩 중..."})]})]}),t.jsx(u,{})]})};try{i.displayName="RandomDefenseCreateButton",i.__docgenInfo={description:"",displayName:"RandomDefenseCreateButton",props:{selectedSlotNo:{defaultValue:null,description:"",name:"selectedSlotNo",required:!0,type:{name:"enum",value:[{value:"0"},{value:"1"},{value:"2"},{value:"3"},{value:"4"},{value:"5"},{value:"6"},{value:"7"},{value:"8"},{value:"9"}]}},isLoaded:{defaultValue:null,description:"",name:"isLoaded",required:!0,type:{name:"boolean"}},onClick:{defaultValue:null,description:"",name:"onClick",required:!0,type:{name:"(event: MouseEvent<HTMLButtonElement, MouseEvent>) => void"}}}}}catch{}export{i as R};
