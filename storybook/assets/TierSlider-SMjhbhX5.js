import{j as u}from"./jsx-runtime-Cf8x2fCZ.js";import{d as v}from"./styled-components.browser.esm-CIS6JKSM.js";import{b as l}from"./typeGuards-32w5_mfc.js";const i=31,d=v.div`
  display: flex;
  align-items: center;
  position: relative;
...
`,m=v.div`
  ...
  background: ${({theme:e})=>`linear-gradient(to right, ${Array.from({length:i}).map((n,a)=>l(a)?`${e.solvedAcTiers[a]} ${a/i*100}%, ${e.solvedAcTiers[a]} ${(a+1)/i*100}%, `:"").join("").slice(0,-2)})`};
...
`,s=v.input`
  ...
  &::-webkit-slider-thumb {
    ...
    border-radius: 7.5px;
    background-color: ${({theme:e,value:n})=>e.solvedAcTiers[n]};
