...
`,mm=g.div`
  ...
  width: 220px;
  margin: 0 auto;
`,fl=()=>{const[n,i]=w.useState(null);return{activeModalName:n,openModal:d=>{i(d)},closeModal:()=>{i(null)}}},va=20,vm=n=>{const{onShowComplainModal:i}=n,[l,u]=w.useState(0),d=()=>{u(y=>{const v=y+1;return l===va&&i(),v})},p=Math.min(1.5,1+Math.max(l-va,0)*.0025),h=Math.max(.5,1-Math.max(l-va,0)*.0025);return{increaseClickCount:d,totamjungScaleX:p,totamjungScaleY:h}},ym=['"알고리즘 분류를 공개하지 않고도 내가 알고 있는 알고리즘만을 이용하여 풀 수 있는 문제인지 확인해 볼 수 있어요"','"알고리즘 분류를 공개할 수 없도록 타이머를 활용하여 일정 시간동안 잠글 수 있어요"','"자주 사용하는 솔브드 검색 쿼리들을 슬롯에 저장해 두고, 백준 내에서 단축키 한 번으로 해당 쿼리로 랜덤 디펜스를 진행할 수 있어요"','"멋지고 웅장한 토탐정 테마를 사용할 수 있어요"','"문제 본문에 다양한 폰트를 취향에 맞게 적용할 수 있어요"','"솔브드에서 제공하는 어려운 문제 경고를 백준에서도 사용할 수 있어요"'],xm=n=>{const{open:i,onClose:l}=n,{currentText:u,startTyping:d,stopTyping:p}=Vg({textList:ym,typingTime:1600,idleTime:3e3,erasingTime:500}),{activeModalName:h,openModal:y,closeModal:v}=fl(),{increaseClickCount:x,totamjungScaleX:S,totamjungScaleY:T}=vm({onShowComplainModal:()=>y("totamjungComplain")});return w.useEffect(()=>{if(i){d();return}p()},[i]),c.jsx(Zn,{title:"토탐정 정보",open:i,onClose:l,children:c.jsxs(lm,{children:[c.jsx(sm,{}),c.jsxs(am,{children:[c.jsx(cm,{src:em,alt:"",onClick:x,$scaleX:S,$scaleY:T}),c.jsx(um,{children:"토탐정"}),c.jsxs(dm,{children:[c.jsx(fm,{children:u}),c.jsx(pm,{})]})]}),c.jsxs(hm,{children:[c.jsxs(pe,{type:"normal",fontSize:14,textAlign:"center",children:["버전:"," ",c.jsx("b",{children:`v${Ae.runtime.getManifest().version} - MV${Ae.runtime.getManifest().manifest_version}`})," ","/ 2025. 12. 14. 빌드"]}),c.jsxs(pe,{type:"normal",fontSize:14,textAlign:"center",children:["개발: ",c.jsx("b",{children:"요술토끼"}),"(",c.jsx(gm,{children:"curious.wzrabbit@gmail.com"}),")"]})]}),c.jsxs(mm,{children:[c.jsx(Ce,{type:"button",name:"버그/건의 제보하기",size:"medium",width:"100%",color:H.color.LIGHT_PURPLE,iconSrc:tm,disabled:!1,onClick:()=>{window.open("mailto:curious.wzrabbit@gmail.com")}}),c.jsx(Ce,{type:"button",name:"릴리즈 노트 보기",size:"medium",width:"100%",color:H.color.LEMON,iconSrc:c.jsx(Tg,{}),disabled:!1,onClick:()=>{window.open("https://github.com/wzrabbit/boj-totamjung/releases")}}),c.jsx(Ce,{type:"button",name:"Github 저장소 방문하기",size:"medium",width:"100%",color:H.color.WHITE,iconSrc:c.jsx(Eg,{}),disabled:!1,onClick:()=>{window.open("https://github.com/wzrabbit/boj-totamjung")}})]}),c.jsx(tn,{title:"왜 그런 짓을...",width:"350px",height:"auto",open:h==="totamjungComplain",message:"그만 좀 두드려 주시면 안 될까요!?",actionType:"confirm",closeOnBackdropClick:!1,onClose:v})]})})},Am={LANDING:"https://wzrabbit.github.io/boj-totamjung"},wm=g.header`
  display: flex;
