...
`,t3=d.div`
  ...
  width: 220px;
  margin: 0 auto;
`,nl=()=>{const[e,t]=x.useState(null);return{activeModalName:e,openModal:o=>{t(o)},closeModal:()=>{t(null)}}},bl=20,n3=e=>{const{onShowComplainModal:t}=e,[n,r]=x.useState(0),o=()=>{r(a=>{const c=a+1;return n===bl&&t(),c})},i=Math.min(1.5,1+Math.max(n-bl,0)*.0025),l=Math.max(.5,1-Math.max(n-bl,0)*.0025);return{increaseClickCount:o,totamjungScaleX:i,totamjungScaleY:l}},r3=['"알고리즘 분류를 공개하지 않고도 내가 알고 있는 알고리즘만을 이용하여 풀 수 있는 문제인지 확인해 볼 수 있어요"','"알고리즘 분류를 공개할 수 없도록 타이머를 활용하여 일정 시간동안 잠글 수 있어요"','"자주 사용하는 솔브드 검색 쿼리들을 슬롯에 저장해 두고, 백준 내에서 단축키 한 번으로 해당 쿼리로 랜덤 디펜스를 진행할 수 있어요"','"멋지고 웅장한 토탐정 테마를 사용할 수 있어요"','"문제 본문에 다양한 폰트를 취향에 맞게 적용할 수 있어요"','"솔브드에서 제공하는 어려운 문제 경고를 백준에서도 사용할 수 있어요"'],o3=e=>{const{open:t,onClose:n}=e,{currentText:r,startTyping:o,stopTyping:i}=Dm({textList:r3,typingTime:1600,idleTime:3e3,erasingTime:500}),{activeModalName:l,openModal:a,closeModal:c}=nl(),{increaseClickCount:u,totamjungScaleX:p,totamjungScaleY:h}=n3({onShowComplainModal:()=>a("totamjungComplain")});return x.useEffect(()=>{if(t){o();return}i()},[t]),s.jsx(Rn,{title:"토탐정 정보",open:t,onClose:n,children:s.jsxs(Vm,{children:[s.jsx(Ym,{}),s.jsxs(Wm,{children:[s.jsx(Zm,{src:Pm,alt:"",onClick:u,$scaleX:p,$scaleY:h}),s.jsx(Qm,{children:"토탐정"}),s.jsxs(qm,{children:[s.jsx(Km,{children:r}),s.jsx(Xm,{})]})]}),s.jsxs(Jm,{children:[s.jsxs(V,{type:"normal",fontSize:"14px",textAlign:"center",children:["버전:"," ",s.jsx("b",{children:`v${U.runtime.getManifest().version} - MV${U.runtime.getManifest().manifest_version}`})," ","/ 2025. 4. 23. 빌드"]}),s.jsxs(V,{type:"normal",fontSize:"14px",textAlign:"center",children:["개발: ",s.jsx("b",{children:"요술토끼"}),"(",s.jsx(e3,{children:"curious.wzrabbit@gmail.com"}),")"]})]}),s.jsxs(t3,{children:[s.jsx(J,{type:"button",name:"버그/건의 제보하기",size:"medium",width:"100%",color:I.color.LIGHT_PURPLE,iconSrc:Bm,ariaLabel:"버그/건의 제보하기",disabled:!1,onClick:()=>{window.open("mailto:curious.wzrabbit@gmail.com")}}),s.jsx(J,{type:"button",name:"릴리즈 노트 보기",size:"medium",width:"100%",color:I.color.LEMON,iconSrc:s.jsx(uh,{}),ariaLabel:"테스트",disabled:!1,onClick:()=>{window.open("https://github.com/wzrabbit/boj-totamjung/releases")}}),s.jsx(J,{type:"button",name:"Github 저장소 방문하기",size:"medium",width:"100%",color:I.color.WHITE,iconSrc:s.jsx(dh,{}),ariaLabel:"테스트",disabled:!1,onClick:()=>{window.open("https://github.com/wzrabbit/boj-totamjung")}})]}),s.jsx(It,{title:"왜 그런 짓을...",width:"350px",height:"auto",open:l==="totamjungComplain",message:"그만 좀 두드려 주시면 안 될까요!?",actionType:"confirm",closeOnBackdropClick:!1,onClose:c})]})})},i3="https://github.com/wzrabbit/boj-totamjung/wiki/%ED%86%A0%ED%83%90%EC%A0%95-%EC%82%AC%EC%9A%A9-%EA%B0%80%EC%9D%B4%EB%93%9C",l3=d.header`
  display: flex;
