import{j as n}from"./jsx-runtime-DEdD30eg.js";import{d as o,l as a}from"./styled-components.browser.esm-CkAH7aAm.js";import{a as v,s as T}from"./index-CElCL35T.js";import{r as t}from"./index-RYns6xqu.js";import{S as D}from"./trash-CO6QCs-j.js";import{f as R}from"./formatDate-DtmnLriP.js";const g=e=>t.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:32,height:32,viewBox:"0 0 24 24",...e},t.createElement("path",{fill:"currentColor",d:"M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2M12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8s8 3.58 8 8s-3.58 8-8 8m.5-13H11v6l5.25 3.15l.75-1.23l-4.5-2.67z"})),s=(e,i,r)=>i?r.color.GRAY:e>=1&&e<=5?r.solvedAcTier[5]:e>=6&&e<=10?r.solvedAcTier[10]:e>=11&&e<=15?r.solvedAcTier[15]:e>=16&&e<=20?r.solvedAcTier[20]:e>=21&&e<=25?r.solvedAcTier[25]:e>=26&&e<=30?r.solvedAcTier[30]:r.color.WHITE,c=(e,i,r,l)=>i?a`
      background-image: ${r?l.solvedAcTier.HIDDEN_DARK_GRADIENT200:l.solvedAcTier.HIDDEN_DARK_GRADIENT100},
        ${l.solvedAcTier.HIDDEN_GRADIENT};
    `:e>=1&&e<=5?a`
      background-image: ${r?l.solvedAcTier.BRONZE_DARK_GRADIENT200:l.solvedAcTier.BRONZE_DARK_GRADIENT100},
        ${l.solvedAcTier.BRONZE_GRADIENT};
    `:e>=6&&e<=10?a`
      background-image: ${r?l.solvedAcTier.SILVER_DARK_GRADIENT200:l.solvedAcTier.SILVER_DARK_GRADIENT100},
        ${l.solvedAcTier.SILVER_GRADIENT};
    `:e>=11&&e<=15?a`
      background-image: ${r?l.solvedAcTier.GOLD_DARK_GRADIENT200:l.solvedAcTier.GOLD_DARK_GRADIENT100},
        ${l.solvedAcTier.GOLD_GRADIENT};
    `:e>=16&&e<=20?a`
      background-image: ${r?l.solvedAcTier.PLATINUM_DARK_GRADIENT200:l.solvedAcTier.PLATINUM_DARK_GRADIENT100},
        ${l.solvedAcTier.PLATINUM_GRADIENT};
    `:e>=21&&e<=25?a`
      background-image: ${r?l.solvedAcTier.DIAMOND_DARK_GRADIENT200:l.solvedAcTier.DIAMOND_DARK_GRADIENT100},
        ${l.solvedAcTier.DIAMOND_GRADIENT};
    `:e>=26&&e<=30?a`
      background-image: ${r?l.solvedAcTier.RUBY_DARK_GRADIENT200:l.solvedAcTier.RUBY_DARK_GRADIENT100},
        ${l.solvedAcTier.RUBY_GRADIENT};
    `:a`
    background-image: ${r?l.solvedAcTier.UNRATED_DARK_GRADIENT200:l.solvedAcTier.UNRATED_DARK_GRADIENT100},
