import{j as t}from"./jsx-runtime-Cf8x2fCZ.js";import{d as n,l as i}from"./styled-components.browser.esm-CIS6JKSM.js";import{g as s}from"./getTransparentHexColor-DN69VCBw.js";const u=n.ol`
  display: inline-flex;
  column-gap: 5px;
...
`,p=n.button`
  ...
  ${({theme:o,$isSelected:l,$isOccupied:r})=>{if(l)return i`
        ...
        outline: 3px solid ${s(o.colors.LEMON,.44)};
