...
\`\`\``,...(x=(m=n.parameters)==null?void 0:m.docs)==null?void 0:x.description}}};var u,y,C,b,h;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => {
    const [isOpen, setIsOpen] = useState(false);
    return <div>
...
}`,...(C=(y=a.parameters)==null?void 0:y.docs)==null?void 0:C.source},description:{story:`\`Modal.tsx\` 모듈에서는 \`<Modal>\`뿐만이 아니라 하단 버튼 메뉴를 구성할 때 사용할 수 있는 \`<ModalActionButtonsContainer>\` 컴포넌트 또한 제공합니다.
