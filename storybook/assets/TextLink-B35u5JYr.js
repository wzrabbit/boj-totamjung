...
`,i=e=>{const{href:l,fontSize:o,children:a}=e;return t.jsxs(s,{href:l,target:"__blank",rel:"noopener",children:[t.jsx(d,{$fontSize:o,children:a}),t.jsx(p,{$fontSize:o,children:t.jsx(c,{})})]})};try{i.displayName="TextLink",i.__docgenInfo={description:"",displayName:"TextLink",props:{href:{defaultValue:null,description:"",name:"href",required:!0,type:{name:"string"}},fontSize:{defaultValue:null,description:"",name:"fontSize",required:!0,type:{name:"number"}}}}}catch{}export{i as T};
