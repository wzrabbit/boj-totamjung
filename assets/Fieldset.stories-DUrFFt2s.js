import{j as p}from"./jsx-runtime-Cf8x2fCZ.js";import{F as S}from"./Fieldset-CTlh4fIW.js";import{I as j}from"./Input-DJiZYGyC.js";import{f as o}from"./index-BAc7KiQ7.js";import"./index-yBjzXJbu.js";import"./styled-components.browser.esm-CIS6JKSM.js";import"./index--qcDGAq6.js";import"./Radio-BjiebFTg.js";import"./Text-5VRYE6Ju.js";const N={title:"components/common/Fieldset",component:S,argTypes:{legend:{description:"필드셋의 제목입니다."},name:{description:"**폼 제출 시** 사용될 `name`값입니다. 실제로 **필드셋에 보이는 제목이 아님**에 유의하세요."},options:{description:"필드셋의 여러 옵션으로 구성된 목록입니다. 각 옵션의 이름을 여기에 명시하면 됩니다."},checkedValue:{description:"현재 선택되어 있는 옵션입니다."},onChange:{description:"필드셋에 체크되어 있는 항목이 변경되어야 할 경우 실행시킬 콜백 함수입니다."},disabled:{description:"필드셋이 비활성화되어 있는지의 여부입니다.",table:{defaultValue:{summary:"false"}}},isVertical:{description:"필드셋의 옵션들을 한 줄에 하나씩, 세로로 정렬해서 표시할 것인지의 여부입니다.",table:{defaultValue:{summary:"false"}}}},parameters:{docs:{description:{component:"`Fieldset`는 어느 하나의 주제에 대해 사용자가 원하는 옵션을 선택할 수 있도록 해주는 컴포넌트입니다. 각 옵션에는 평범하게 `string`을 사용하거나, `ReactNode`와 같은 컴포넌트를 사용할 수 있습니다."}}}},E="https://images.unsplash.com/photo-1599819177626-b50f9dd21c9b?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",s=[{label:"사과",value:"apple"},{label:"배",value:"pear"},{label:"파인애플",value:"pineapple"},{label:"수박",value:"watermelon"}],G=[...s,{label:p.jsx("img",{src:E,width:"120px",alt:"포도"}),value:"grape"},{label:p.jsx(j,{type:"text",textAlign:"left",width:"200px",placeholder:"직접 입력...",ariaLabel:"좋아하는 과일 직접 입력",value:"",hasError:!1,onChange:()=>{}}),value:"other"}],l=Array.from({length:20}).map(()=>{const i=crypto.randomUUID();return{label:i,value:i}}),r={args:{legend:"좋아하는 과일",name:"favoriteFruit",options:s,checkedValue:"apple",onChange:o()}},t={args:{legend:"좋아하는 과일",name:"favoriteFruit",options:s,checkedValue:"apple",isVertical:!0,onChange:o()}},e={args:{legend:"매우 많은 옵션",name:"tooManyOptions",options:l,checkedValue:l[0].value,onChange:o()}},a={args:{legend:"좋아하는 과일",name:"favoriteFruit",options:G,checkedValue:"apple",isVertical:!0,onChange:o()}},n={args:{legend:"좋아하는 과일",name:"favoriteFruit",options:s,checkedValue:"apple",disabled:!0,onChange:o()}};var c,d,m;r.parameters={...r.parameters,docs:{...(c=r.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    legend: '좋아하는 과일',
    name: 'favoriteFruit',
    options,
...
}`,...(w=(M=n.parameters)==null?void 0:M.docs)==null?void 0:w.source},description:{story:"다른 `Fieldset`의 옵션에 따라 일부 `Fieldset`을 비활성화시킬 수도 있습니다.",...(I=(A=n.parameters)==null?void 0:A.docs)==null?void 0:I.description}}};const P=["Default","Vertical","TooManyOptions","ComponentOptions","Disabled"];export{a as ComponentOptions,r as Default,n as Disabled,e as TooManyOptions,t as Vertical,P as __namedExportsOrder,N as default};
