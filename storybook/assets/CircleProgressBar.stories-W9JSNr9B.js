...
}`,...(t=(s=o.parameters)==null?void 0:s.docs)==null?void 0:t.source}}};var a,c,n,i,p;r.parameters={...r.parameters,docs:{...(a=r.parameters)==null?void 0:a.docs,source:{originalSource:`{
  args: {
    size: 45,
    strokeWidth: 22.5,
    progress: 65,
...
}`,...(n=(c=r.parameters)==null?void 0:c.docs)==null?void 0:n.source},description:{story:"`strokeWidth` 값을 `size`의 절반으로 조절하면 꽉 찬 프로그레스 바를 만들 수 있습니다.",...(p=(i=r.parameters)==null?void 0:i.docs)==null?void 0:p.description}}};const C=["Default","Filled"];export{o as Default,r as Filled,C as __namedExportsOrder,k as default};
