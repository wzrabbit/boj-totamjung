import{j as s}from"./jsx-runtime-DEdD30eg.js";import{R as D}from"./RandomDefenseHistoryList-D6D0AFIG.js";import{r as m}from"./index-RYns6xqu.js";import{S as l}from"./commands-CzqO23sC.js";import{d as h,e as R,f as _,g as S,h as M,i as T,M as N}from"./randomDefense-DFxRSgnp.js";import{i as u}from"./randomDefenseHistoryValidator-HqCX0m6_.js";import{c as A}from"./typeGuards-BB3TV_oj.js";import{b,c as w}from"./defaultValues-5WESY1KB.js";import{d as i}from"./styled-components.browser.esm-CkAH7aAm.js";import{S as L}from"./Switch-HPixtSTV.js";import{N as O}from"./NamedFrame-D-XXrU6-.js";import{S as j}from"./trash-CO6QCs-j.js";import{S as $}from"./package-F1HZRHho.js";import{S as v}from"./SimpleModal-BnTyCKaN.js";import{u as C}from"./useModal-CV8qRtLl.js";import{t as I}from"./theme-YzccoX_F.js";const B=e=>{if(!A(e))return!1;const[o,t,r,n,a,d,p]=e.split(/[-:.TZ]/).map(Number);return o>=1&&o<=9999&&t>=1&&t<=12&&r>=1&&r<=31&&n>=0&&n<=23&&a>=0&&a<=59&&d>=0&&d<=59&&p>=0&&p<=999},z=e=>u(e)&&e.problemId%1===0&&e.problemId>=R&&e.problemId<=_&&e.title.length<=S&&B(e.createdAt)&&e.tier%1===0&&e.tier>=M&&e.tier<=T,F=e=>[...e].sort((o,t)=>o.createdAt>t.createdAt?-1:1),H=e=>{if(!Array.isArray(e))return b;const o=[];return e.forEach(t=>{u(t)&&z(t)&&o.push(t)}),F(o).slice(0,h)},P=e=>typeof e=="boolean"?e:w,k=async()=>{const e=await browser.storage.local.get([l.RANDOM_DEFENSE_HISTORY,l.IS_TIER_HIDDEN]),o=e[l.RANDOM_DEFENSE_HISTORY],t=e[l.IS_TIER_HIDDEN],r=H(o),n=P(t);return{randomDefenseHistory:r,isHidden:n}},G=async(e,o)=>{if(!Array.isArray(e)||typeof o!="boolean")return;const t=H(e);browser.storage.local.set({[l.RANDOM_DEFENSE_HISTORY]:t,[l.IS_TIER_HIDDEN]:o})},Y=()=>{const[e,o]=m.useState([]),[t,r]=m.useState(!0),[n,a]=m.useState(!1),d=e.length===0;return m.useEffect(()=>{(async()=>{const c=await k();r(c.isHidden),o(c.randomDefenseHistory),a(!0)})()},[]),m.useEffect(()=>{n&&G(e,t)},[e,t]),{items:e,isHidden:t,isLoaded:n,isEmpty:d,deleteHistoryById:c=>{const f=e.filter(E=>`${E.problemId}-${E.createdAt}`!==c);o(f)},clearHistory:()=>{o([])},updateIsHidden:c=>{r(c.target.checked)}}},X=i.div`
  display: flex;
