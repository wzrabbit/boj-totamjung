import{j as t}from"./jsx-runtime-DEdD30eg.js";import{R as E}from"./RandomDefenseHistoryList-D6D0AFIG.js";import{r as m}from"./index-RYns6xqu.js";import{S as l}from"./commands-CzqO23sC.js";import{d as g,e as D,f as R,g as _,h as S,i as T}from"./randomDefense-BMDfqqJr.js";import{i as y}from"./randomDefenseHistoryValidator-HqCX0m6_.js";import{c as N}from"./typeGuards-BB3TV_oj.js";import{b,c as M}from"./defaultValues-5WESY1KB.js";import{d as n}from"./styled-components.browser.esm-CkAH7aAm.js";import{S as A}from"./Switch-HPixtSTV.js";import{N as j}from"./NamedFrame-D-XXrU6-.js";import{S as w}from"./trash-CO6QCs-j.js";import{S as L}from"./package-F1HZRHho.js";import{S as O}from"./SimpleModal-DOWnMJLG.js";import{u as v}from"./useModal-CV8qRtLl.js";const $=e=>{if(!N(e))return!1;const[s,o,r,i,a,d,p]=e.split(/[-:.TZ]/).map(Number);return s>=1&&s<=9999&&o>=1&&o<=12&&r>=1&&r<=31&&i>=0&&i<=23&&a>=0&&a<=59&&d>=0&&d<=59&&p>=0&&p<=999},z=e=>y(e)&&e.problemId%1===0&&e.problemId>=D&&e.problemId<=R&&e.title.length<=_&&$(e.createdAt)&&e.tier%1===0&&e.tier>=S&&e.tier<=T,B=e=>[...e].sort((s,o)=>s.createdAt>o.createdAt?-1:1),u=e=>{if(!Array.isArray(e))return b;const s=[];return e.forEach(o=>{y(o)&&z(o)&&s.push(o)}),B(s).slice(0,g)},k=e=>typeof e=="boolean"?e:M,C=async()=>{const e=await browser.storage.local.get([l.RANDOM_DEFENSE_HISTORY,l.IS_TIER_HIDDEN]),s=e[l.RANDOM_DEFENSE_HISTORY],o=e[l.IS_TIER_HIDDEN],r=u(s),i=k(o);return{randomDefenseHistory:r,isHidden:i}},F=async(e,s)=>{if(!Array.isArray(e)||typeof s!="boolean")return;const o=u(e);browser.storage.local.set({[l.RANDOM_DEFENSE_HISTORY]:o,[l.IS_TIER_HIDDEN]:s})},P=()=>{const[e,s]=m.useState([]),[o,r]=m.useState(!0),[i,a]=m.useState(!1),d=e.length===0;return m.useEffect(()=>{(async()=>{const c=await C();r(c.isHidden),s(c.randomDefenseHistory),a(!0)})()},[]),m.useEffect(()=>{i&&F(e,o)},[e,o]),{items:e,isHidden:o,isLoaded:i,isEmpty:d,deleteHistoryById:c=>{const H=e.filter(f=>`${f.problemId}-${f.createdAt}`!==c);s(H)},clearHistory:()=>{s([])},updateIsHidden:c=>{r(c.target.checked)}}},Y=n.div`
  display: flex;
