...
`,lm=h.div`
  ...
  width: 220px;
  margin: 0 auto;
`,al=()=>{const[n,i]=T.useState(null);return{activeModalName:n,openModal:d=>{i(d)},closeModal:()=>{i(null)}}},pa=20,sm=n=>{const{onShowComplainModal:i}=n,[l,u]=T.useState(0),d=()=>{u(y=>{const v=y+1;return l===pa&&i(),v})},p=Math.min(1.5,1+Math.max(l-pa,0)*.0025),g=Math.max(.5,1-Math.max(l-pa,0)*.0025);return{increaseClickCount:d,totamjungScaleX:p,totamjungScaleY:g}},am=['"알고리즘 분류를 공개하지 않고도 내가 알고 있는 알고리즘만을 이용하여 풀 수 있는 문제인지 확인해 볼 수 있어요"','"알고리즘 분류를 공개할 수 없도록 타이머를 활용하여 일정 시간동안 잠글 수 있어요"','"자주 사용하는 솔브드 검색 쿼리들을 슬롯에 저장해 두고, 백준 내에서 단축키 한 번으로 해당 쿼리로 랜덤 디펜스를 진행할 수 있어요"','"멋지고 웅장한 토탐정 테마를 사용할 수 있어요"','"문제 본문에 다양한 폰트를 취향에 맞게 적용할 수 있어요"','"솔브드에서 제공하는 어려운 문제 경고를 백준에서도 사용할 수 있어요"'],cm=n=>{const{open:i,onClose:l}=n,{currentText:u,startTyping:d,stopTyping:p}=Gg({textList:am,typingTime:1600,idleTime:3e3,erasingTime:500}),{activeModalName:g,openModal:y,closeModal:v}=al(),{increaseClickCount:E,totamjungScaleX:S,totamjungScaleY:R}=sm({onShowComplainModal:()=>y("totamjungComplain")});return T.useEffect(()=>{if(i){d();return}p()},[i]),c.jsx(Wn,{title:"토탐정 정보",open:i,onClose:l,children:c.jsxs(qg,{children:[c.jsx(Kg,{}),c.jsxs(Xg,{children:[c.jsx(Jg,{src:Yg,alt:"",onClick:E,$scaleX:S,$scaleY:R}),c.jsx(em,{children:"토탐정"}),c.jsxs(tm,{children:[c.jsx(nm,{children:u}),c.jsx(rm,{})]})]}),c.jsxs(om,{children:[c.jsxs(Te,{type:"normal",fontSize:"14px",textAlign:"center",children:["버전:"," ",c.jsx("b",{children:`v${Ae.runtime.getManifest().version} - MV${Ae.runtime.getManifest().manifest_version}`})," ","/ 2025. 8. 14. 빌드"]}),c.jsxs(Te,{type:"normal",fontSize:"14px",textAlign:"center",children:["개발: ",c.jsx("b",{children:"요술토끼"}),"(",c.jsx(im,{children:"curious.wzrabbit@gmail.com"}),")"]})]}),c.jsxs(lm,{children:[c.jsx(Ce,{type:"button",name:"버그/건의 제보하기",size:"medium",width:"100%",color:H.color.LIGHT_PURPLE,iconSrc:Wg,ariaLabel:"버그/건의 제보하기",disabled:!1,onClick:()=>{window.open("mailto:curious.wzrabbit@gmail.com")}}),c.jsx(Ce,{type:"button",name:"릴리즈 노트 보기",size:"medium",width:"100%",color:H.color.LEMON,iconSrc:c.jsx(gg,{}),ariaLabel:"테스트",disabled:!1,onClick:()=>{window.open("https://github.com/wzrabbit/boj-totamjung/releases")}}),c.jsx(Ce,{type:"button",name:"Github 저장소 방문하기",size:"medium",width:"100%",color:H.color.WHITE,iconSrc:c.jsx(mg,{}),ariaLabel:"테스트",disabled:!1,onClick:()=>{window.open("https://github.com/wzrabbit/boj-totamjung")}})]}),c.jsx(en,{title:"왜 그런 짓을...",width:"350px",height:"auto",open:g==="totamjungComplain",message:"그만 좀 두드려 주시면 안 될까요!?",actionType:"confirm",closeOnBackdropClick:!1,onClose:v})]})})},um="https://github.com/wzrabbit/boj-totamjung/wiki/%ED%86%A0%ED%83%90%EC%A0%95-%EC%82%AC%EC%9A%A9-%EA%B0%80%EC%9D%B4%EB%93%9C",dm=h.header`
  display: flex;
