...
`,Gh=h.div`
  ...
  width: 220px;
  margin: 0 auto;
`,Vh=['"알고리즘 분류를 공개하지 않고도 내가 알고 있는 알고리즘만을 이용하여 풀 수 있는 문제인지 확인해 볼 수 있어요"','"알고리즘 분류를 공개할 수 없도록 타이머를 활용하여 일정 시간동안 잠글 수 있어요"','"자주 사용하는 솔브드 검색 쿼리들을 슬롯에 저장해 두고, 백준 내에서 단축키 한 번으로 해당 쿼리로 랜덤 디펜스를 진행할 수 있어요"','"멋지고 웅장한 토탐정 테마를 사용할 수 있어요"','"문제 본문에 다양한 폰트를 취향에 맞게 적용할 수 있어요"','"솔브드에서 제공하는 어려운 문제 경고를 백준에서도 사용할 수 있어요"'],Uh=e=>{const{open:t,onClose:n}=e,{currentText:r,startTyping:o,stopTyping:i}=Sh({textList:Vh,typingTime:1600,idleTime:3e3,erasingTime:500});return S.useEffect(()=>{if(t){o();return}i()},[t]),s.jsx(to,{title:"토탐정 정보",open:t,onClose:n,children:s.jsxs(Oh,{children:[s.jsx(jh,{}),s.jsxs(Mh,{children:[s.jsx($h,{src:Ih,alt:""}),s.jsx(zh,{children:"토탐정"}),s.jsxs(Ph,{children:[s.jsx(Hh,{children:r}),s.jsx(Bh,{})]})]}),s.jsxs(Fh,{children:[s.jsxs(V,{type:"normal",fontSize:"14px",textAlign:"center",children:["버전:"," ",s.jsx("b",{children:`v${ee.runtime.getManifest().version} - MV${ee.runtime.getManifest().manifest_version}`})," ","/ 2024. 10. 16. 빌드"]}),s.jsxs(V,{type:"normal",fontSize:"14px",textAlign:"center",children:["개발: ",s.jsx("b",{children:"요술토끼"}),"(",s.jsx(bh,{children:"curious.wzrabbit@gmail.com"}),")"]})]}),s.jsxs(Gh,{children:[s.jsx(ae,{type:"button",name:"버그/건의 제보하기",size:"medium",width:"100%",color:oe.color.LIGHT_PURPLE,iconSrc:Dh,ariaLabel:"버그/건의 제보하기",disabled:!1,onClick:()=>{window.open("mailto:curious.wzrabbit@gmail.com")}}),s.jsx(ae,{type:"button",name:"릴리즈 노트 보기",size:"medium",width:"100%",color:oe.color.LEMON,iconSrc:s.jsx(ip,{}),ariaLabel:"테스트",disabled:!1,onClick:()=>{window.open("https://github.com/wzrabbit/boj-totamjung/releases")}}),s.jsx(ae,{type:"button",name:"Github 저장소 방문하기",size:"medium",width:"100%",color:oe.color.WHITE,iconSrc:s.jsx(lp,{}),ariaLabel:"테스트",disabled:!1,onClick:()=>{window.open("https://github.com/wzrabbit/boj-totamjung")}})]})]})})},Wh="https://github.com/wzrabbit/boj-totamjung/wiki/%ED%86%A0%ED%83%90%EC%A0%95-%EC%82%AC%EC%9A%A9-%EA%B0%80%EC%9D%B4%EB%93%9C",qh=h.header`
  display: flex;
